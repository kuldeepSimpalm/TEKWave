Ext.define('ux.signaturefield', {
	...
	initCanvas: function(){		
	  ...
	  if (oCanvas) {		 
		...
		this.oCtx.fillStyle   = 'rgba(0,0,0,0)';//#FFFFFF
		this.oCtx.fillRect  (0, 0, this.width, this.height);
          
           
           // These lines don't change anything
          // this.oCtx.mozImageSmoothingEnabled = false;
          // this.oCtx.webkitImageSmoothingEnabled = false;
	...
	canvasTouchMove: function(e) {
		if (this.bMouseIsDown) {
			...
			this.oCtx.strokeStyle = "blue";//rgba(0,0,0, 1)
	...
	setValue: function(value) {		
		//this.getComponent().setHtml('<img src="'+value+'" width="'+this.width+'"  height="'+this.height+'" />');
         // this.getComponent().setHtml('<img src="'+value+'" width="MyTechReport.app.signWidth-10"  height="MyTechReport.app.signWidth-10" />');
             this.getComponent().setHtml('<div valign="middle" align="center" style="padding-top : 2%;                " > <img src="'+value+'" width="250"  height="80" /> </div>');
